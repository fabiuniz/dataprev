...
echo "🐳 Verificando infraestrutura em containers para a Task 02 (Spring Boot Puro)..."
...
# =====================================================================
# 3. Execução do Spring Boot
# =====================================================================
echo "🏃 Compilando e executando o ecossistema Spring Boot..."
